...
@if (theme_option('theme_breadcrumb_enabled', true) && $breadcrumbStyle !== 'none')
    <section
        @class([
            ...
            'mb-50' => $breadcrumbStyle !== 'without-title' && empty($breadcrumbHeight),
            'pb-30 mb-50' => $breadcrumbStyle === 'without-title' && empty($breadcrumbHeight),
            'breadcrumb__style-2 include-bg' => $breadcrumbStyle === 'without-title',
            'pb-30' => $breadcrumbStyle === 'without-title' && empty($breadcrumbHeight),
            ...
            '' => empty($breadcrumbHeight) || $breadcrumbHeight < 90,
    ...
    >
    <div style="background:rgba(0,0,0,0.5); width:100%; padding-bottom: 60px; padding-top: 60px;">
